...
import { stringify, uneval } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/devalue/index.js';
import destr from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "/Users/vishalpulikottil/Instinctive Clients/Nova (CI)/nova-course-creator-ai";
...
const getClientManifest = () => import('file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/vishalpulikottil/Instinctive%20Clients/Nova%20(CI)/nova-course-creator-ai/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
