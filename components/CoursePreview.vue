    ...
    <div class="p-6">
      <div class="bg-blue-500 text-white p-8 rounded-lg text-center mb-8">
        <h1 class="text-2xl font-bold mb-2">
          {{ store.title || 'Pathway name' }}
        </h1>
        <p class="text-blue-100">
          {{ store.description || 'Short description that tells what the pathway is about.' }}
        </p>
        <button class="mt-4 bg-white/60 text-blue-500 px-6 py-2 rounded-md w-[100px] h-[30px]">
        </button>
      </div>
